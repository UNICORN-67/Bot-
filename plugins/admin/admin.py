...
user = await extract_user(message) if not user: return await message.reply_text(("admin.no_user")) await message.chat.unban_member(user.id) await message.reply_text(_("admin.unbanned"))

@app.on_message(filters.command("kick") & filters.group) 
async def kick_user(, message: Message): 
user = await extract_user(message) if not user: return await message.reply_text(("admin.no_user")) await message.chat.ban_member(user.id) await message.chat.unban_member(user.id) await message.reply_text(_("admin.kicked"))

@app.on_message(filters.command("gban") & filters.group) 
async def gban_user(, message: Message): 
await message.reply_text(("admin.gban"))

@app.on_message(filters.command("ungban") & filters.group) 
async def ungban_user(, message: Message): await message.reply_text(("admin.ungban"))
...
await message.reply_text(("admin.warned"))

@app.on_message(filters.command("unwarn") & filters.group) 
async def unwarn_user(, message: Message): await message.reply_text(("admin.unwarned"))
